...
export {
  ...
  type ChapterImportItem,
  type ChapterImportWarning,
} from "./import/chapter-import-planner.js";
export {
  appendAuditHistory,
  loadAuditHistory,
  type AuditHistoryEntry,
} from "./utils/audit-history.js";
export {
  loadChapterGoals,
  saveChapterGoals,
  getChapterGoal,
...
export {
  ...
  type RoleCard,
  type RoleCardFrontmatter,
  type RoleCardListItem,
  type RoleTier,
...
export { getErrorReporter, resetErrorReporter, captureError, captureInfo, captureWarning, type ErrorReporter, type ErrorContext } from "./observability/reporter.js";
export { structuredLog } from "./utils/structured-log.js";
...
export {
  ...
  runPersistenceStage,
  evaluateNormalizationNeed,
} from "./pipeline/stages/index.js";
export type {
  NotificationInput,
  PersistenceInput,
  PersistenceOutput,
  LengthNormalizeInput,
  LengthNormalizeOutput,
} from "./pipeline/stages/index.js";
